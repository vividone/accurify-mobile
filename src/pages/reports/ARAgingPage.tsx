...
import { useArAging } from '@/queries/gl.queries';
...
export function ARAgingPage() {
  ...
  const { data: report, isLoading, isError, error } = useArAging(asOfDate);
  ...
  return (
    <>
      <PageHeader title="AR Aging Report" backTo="/app/dashboard" />
          ...
          <Card>
            <div className="flex flex-col items-center py-8 text-center">
              ...
              <p className="text-helper-01 text-gray-50">
                Create invoices to see your AR aging breakdown.
              </p>
            </div>
          </Card>
        )}
            ...
            <Card>
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-label-01 text-gray-50">Total Invoices</p>
                  <p className="text-heading-03 font-semibold tabular-nums text-gray-100">
                    {report.totalCount}
                  </p>
                </div>
              ...
              <Card padding={false}>
                <div className="px-4 py-3 border-b border-gray-10">
                  <p className="text-label-01 text-gray-50 font-medium">
                    By Client ({report.partyTotals.length})
                  </p>
                </div>
                {report.partyTotals
                  .slice()
